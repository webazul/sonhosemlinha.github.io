        ...
        return {
          ...
          content: (
            <div>
              ...
              <p>Sonhos em Linha<br />
              Rua das Flores, 123<br />
              1200-000 Lisboa, Portugal<br />
              Email: info@sonhosemlinha.pt<br />
              Telefone: +351 900 000 000</p>
              ...
              <ul>
                ...
                <li><strong>Dados do serviço:</strong> Tipo de serviço solicitado, data do evento, descrição do projeto</li>
              ...
              <ul>
                ...
                <li>Prestar os serviços de costura solicitados</li>
              ...
              <p>Para exercer os seus direitos, contacte-nos através de info@sonhosemlinha.pt</p>
      ...
      case 'terms':
        return {
          ...
          content: (
            <div>
              <h3>1. Objeto</h3>
              <p>Os presentes termos regulam a prestação de serviços de costura personalizada pela Sonhos em Linha.</p>

              <h3>2. Serviços</h3>
              <p>Prestamos os seguintes serviços:</p>
              <ul>
                <li>Confeção de vestidos de noiva sob medida</li>
                <li>Criação de roupas sociais e de festa personalizadas</li>
                <li>Ajustes e reformas de peças de vestuário</li>
                <li>Consultoria de estilo e design</li>
              </ul>

              <h3>3. Processo de Encomenda</h3>
              ...
              <p><strong>3.4. Provas:</strong> Incluídas no serviço conforme especificado</p>

              <h3>4. Prazos</h3>
              <p><strong>4.1.</strong> Os prazos são acordados individualmente e confirmados por escrito</p>
              <p><strong>4.2.</strong> Vestidos de noiva: normalmente 3-6 meses</p>
              <p><strong>4.3.</strong> Outras peças: 2-8 semanas conforme complexidade</p>
              <p><strong>4.4.</strong> Prazos urgentes sujeitos a suplemento</p>
              ...
              <h3>6. Provas e Ajustes</h3>
              <p><strong>6.1.</strong> Incluímos até 3 provas no preço base</p>
              <p><strong>6.2.</strong> Provas adicionais: €25 cada</p>
              <p><strong>6.3.</strong> Cliente deve comparecer às provas agendadas</p>
              <p><strong>6.4.</strong> Alterações de peso significativas podem afetar o resultado final</p>

              <h3>7. Materiais</h3>
              <p><strong>7.1.</strong> Utilizamos apenas tecidos de qualidade premium</p>
              <p><strong>7.2.</strong> Cliente pode fornecer tecidos próprios (sem garantia de resultado)</p>
              <p><strong>7.3.</strong> Sobras de tecido permanecem com o atelier</p>
              ...
              <h3>9. Garantias</h3>
              <p><strong>9.1.</strong> Garantimos a qualidade dos materiais e confeção</p>
              <p><strong>9.2.</strong> Pequenos ajustes gratuitos nos primeiros 30 dias</p>
              <p><strong>9.3.</strong> Não nos responsabilizamos por danos resultantes de uso inadequado</p>

              <h3>10. Propriedade Intelectual</h3>
              <p>Todos os designs criados são propriedade exclusiva da Sonhos em Linha.</p>
        ...
        return {
          ...
          content: (
            <div>
              ...
              <h3>9. Contacto</h3>
              <p>Para questões sobre cookies, contacte-nos em info@sonhosemlinha.pt</p>
